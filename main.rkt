...
; SPEED is how many pixels the PLAYER moves per tick.
(define SPEED 4)

; player contains the coordinates and heading of the playable character 
; the heading is the direction in which the playable character will move on the x-axis.
; the amount the player moves on the y-axis is derived from the heading with the function f(x) = SPEED - |x|
